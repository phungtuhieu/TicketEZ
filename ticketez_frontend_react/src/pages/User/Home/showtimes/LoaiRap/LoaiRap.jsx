    ...
    return ( 
        <div className={cx('wrapper')}>
            <div className={cx('container', {active: a, titleA: !a })}>
                ...
                <img className={cx('img')} src="https://homepage.momocdn.net/next-js/_next/static/public/cinema/dexuat-icon.svg" alt="" />
                </div>
            ...
            <div className={cx('container')}>
                ...
                <div className={cx('title')}>Galaxy Ciádasdasd</div>
            </div>
            <div className={cx('container')}>
                <div className={cx('border')}>
                <img className={cx('img')} src="https://homepage.momocdn.net/next-js/_next/static/public/cinema/dexuat-icon.svg" alt="" />
