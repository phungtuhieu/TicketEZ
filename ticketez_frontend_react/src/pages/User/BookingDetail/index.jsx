import { Badge, Button, Col, Descriptions, Divider, Input, Modal, QRCode, Row, Space, Spin, Tag } from 'antd';
                        ...
                        <Col span={11} className={cx('wrapp-qrcode')}>
                            <Row>
                                ...
                                <Col span={24} className="text-center">
                                    <FontAwesomeIcon icon={solidIcon.faQrcode} /> &nbsp; Sử dụng App VNPay hoặc <br />{' '}
