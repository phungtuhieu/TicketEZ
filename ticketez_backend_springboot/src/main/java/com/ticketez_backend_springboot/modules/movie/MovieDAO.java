...
public interface MovieDAO extends JpaRepository<Movie, Long> {
        ...
        @Query("SELECT m, COUNT(b) as bookingCount " +
                        ...
                        "GROUP BY m.id, m.country,m.banner, m.description, m.duration, m.movieProducer, m.movieStudio, m.mpaaRating, m.poster, m.rating, m.releaseDate, m.title, m.videoTrailer "
                        +
